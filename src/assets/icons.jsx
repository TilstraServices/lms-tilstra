// ── Tilstra LMS Icon Library ──
// Gebruik: import { PotloodIcoon } from '../../assets/icons.jsx'
// Kleur wordt automatisch geërfd via fill="currentColor"
// Pas grootte aan via de size prop (standaard 18px)

export function PotloodIcoon({ size = 18 }) {
  return (
...
export function XIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function PijlLinksIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function PijlRechtsIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function PijlOmlaagIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function GebruikerIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function UitloggenIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function CheckIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function GeschiedenisIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function LinkIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function ExternIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function BoekenIcoon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function ParagraafIcoon({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
...
export function VraagIcoon({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="currentColor">
