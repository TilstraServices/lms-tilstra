...
import TraineeOverzichtBlok from "./blokken/TraineeOverzichtBlok";

function InstellingenBlok({ email }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      >
        ...
        <p style={{ fontSize: "0.85rem", color: "var(--grijs-700)" }}>
          <strong>Rol:</strong> {rol || "Laden..."}
        </p>
      </div>

      {(rol === "leidinggevende" || rol === "beheerder") && (
        <div
          style={{
            background: "white",
            border: "1px solid var(--grijs-200)",
        ...
        >
          ...
          >
            Als leidinggevende heb je toegang tot het beheerdashboard voor het
            beheren van modules, opgaves en gebruikers.
          </p>
          <button
  ...
  const navigatie = [
    {
      ...
      blok: <TraineeOverzichtBlok email={email} />,
      sectie: "Menu",
    },
    {
      label: "Mijn Trainees",
      ...
      blok: <p>Trainees blok komt hier</p>,
      sectie: "Menu",
    },
    ...
    },
    {
      ...
      blok: <InstellingenBlok email={email} />,
      sectie: "Beheer",
    },
    {
      label: "Gebruikers",
